    ...
    <div className='app-container terms'>
        <div className='container'>
            <div className='terms-header'>
              <h1>USER TERMS & CONDITIONS OF SERVICE</h1>
              <p>Last updated July, 2022</p>
            </div>
             <div className='terms-section'>
               <h3>Terms of Use</h3>
               <p>These Terms govern your access to, usage of all content, Product and Services available at website (the “Service”) operated by (“us”, “we”, or “our”). Your access to our services is subject to your acceptance, without modification, of all of the terms and conditions contained herein and all other operating rules and policies published and that may be published from time to time by us. Please read the Agreement carefully before accessing or using our Services. By accessing or using any part of our Services, you agree to be bound by these Terms. If you do not agree to any part of the terms of the Agreement, then you may not access or use our Services.</p>
             </div>

             <div className='terms-section'>
               <h3>Blog Comments Policy</h3>
               <p>We encourage and welcome comments on our blog. We would also like to thank everyone who takes their time out in posting comments on Feed3. We generally post all the comments which are useful to all of our readers. However, there are certain instances where we edit or delete the comment(s). This includes:</p>
               <ul>
                 <li>Comments that are posted solely for the purpose of promotion.</li>
                 <li>Comments that are spam or have a spammy nature.</li>
                 <li>Comments which use vulgar language or swear words.</li>
                 <li>Comments which attack / harass another person individually.</li>

               </ul>
               <p style={{color:'white'}}>We recommend everyone to follow our comment policy rules to help you keep the blog a constructive place for discussion. We reserve the right to edit or delete comments submitted to this blog at any time without notice. The comment policy may be changed at any point of time.</p>
             </div>

             <div className='terms-section'>
               <h3>Newsletter disclaimer</h3>
               <h4>Copyright</h4>
               <p>We at Feed3, reserve all copyrights on text or images on the newsletter. The text or images in the newsletter may not be copied or distributed without prior permission of Feed3. If there is any approved use of content, the following conditions should be followed: The source of copied material should be mentioned as Feed3, this statement should appear on all forms of distribution.</p>       
             </div>
             ...
             <div className='terms-section'>
               <h4>No Warranty</h4>
               <p>The information contained in this newsletter is provided by Feed3 as a service/promotion to its users, subscribers, customers and possible others. It does not contain (legal) advice. Although we try to provide quality information, we do not guarantee of results obtained from the use of this information, and without warranty of any kind, express or implied, including, but not limited to warranties of performance for a particular </p>
             </div>
             <div className='terms-section'>
               <h4>No Warranty</h4>
             ...
             <div className='terms-section'>
               <h4>No Liability</h4>
               <p>In no way is Feed3 is liable to user or any other party for any damages, costs of any character including but not limited to direct or indirect, consequential, incidental or other costs or damages, via the use of the information contained in the newsletters.</p>
             </div>
             <div className='terms-section'>
               <h4>Changes</h4>
